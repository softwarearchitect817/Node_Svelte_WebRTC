...
var app = (function () {
    ...
    /* src\Video.svelte generated by Svelte v3.44.1 */
    ...
    function create_default_slot(ctx) {
    	...
    	route1 = new Route({
    			props: { path: "/video", component: Video },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 9, 2, 223);
    			add_location(nav, file, 11, 2, 243);
    			add_location(header, file, 8, 1, 212);
    			add_location(main, file, 17, 1, 332);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { url = "http://localhost:5000" } = $$props;
    	...
    	$$self.$capture_state = () => ({ Router, Link, Route, Home, Video, url });
